...
---
## 1️ Constructor Injection (Внедрение через конструктор)
...
---
## 2️ Setter / Property Injection (Внедрение через свойство)
...
---
## 3️ Method / Parameter Injection (Внедрение через параметр метода)
...
---
## 4️ Factory Pattern (Фабрика зависимостей)
...
---
## 5️ DI-контейнеры / IoC-фреймворки
